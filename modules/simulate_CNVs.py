...
def generate_cnvs(CNV_dict, min_size, max_size, gene_info, save_csv = None):
        ...
        Parameters:
            ...
            - gene_info (str): The path to the gene information from the *Ensmbl_BioMart_gene_info.txt* file, including 
                    'Gene stable ID', 'Chromosome/scaffold name', 'Gene start (bp)', 'Gene end (bp)', 'Gene name' of the human genome GRCh38.
